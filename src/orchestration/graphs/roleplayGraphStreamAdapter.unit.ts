      ...
      runPreGeneration: async () =>
        fakePreGenerationResult({
          resolvedContext: {
            ...
            memoryCorrections: [],
            latestTurnDelta: null,
            queryRewrite: { intent: "general", confidence: 1, segments: [], combined_for_embedding: "", entities: [], parseOk: true, structuralParseOk: true, labelOk: true } as any,
            retrievalPlan: { intent: "general", canonMode: "skip", durableMemoryTopK: 8, sessionRecallTopK: 12, structMemEntryTopK: 16, structMemConsolidationTopK: 4, openThreadTopK: 4, broadFailOpen: false, forceOpenThreads: false, contextNeed: { needsRecentTurns: true, needsOlderSessionRecall: false, needsDurableMemory: false, needsStructMem: false, needsStructMemConsolidation: false, needsCanon: false, needsWeb: false, injectionMode: "full", reason: "test" } } as any,
            turnType: "general_roleplay" as any,
            isFirstUserTurn: false,
            recallThoughtContext: {
