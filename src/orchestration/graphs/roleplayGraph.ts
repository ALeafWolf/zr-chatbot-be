 ...
 *
 * ‚ö†Ô∏è DEV/SMOKE-ONLY ‚Ä?NOT the production stream path.
 *
 ...
 * - Hardcoded `isFirstUserTurn: false` ‚Ä?does not detect first-turn metadata.
 * - Persistence uses `thoughts: []` ‚Ä?recall thoughts are not accumulated.
